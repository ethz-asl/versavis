...
// spikes).
///////////////////////////////////////////////////////////////////////////////////////////////
void ADIS16448AMLZ::updateData() { sensor_data_ = sensorReadWoCRC(); }

/////////////////////////////////////////////////////////////////////////////////////////////
// Method to update the internally stored sensor data recusivelly by checking
// the validity.
///////////////////////////////////////////////////////////////////////////////////////////////
void ADIS16448AMLZ::updateDataRecursive(unsigned int depth) {
  ...
  if (sensor_data_[11] != regRead(TEMP_OUT) &&
